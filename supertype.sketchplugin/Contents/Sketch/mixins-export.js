...
/* harmony import */ var _util_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./util/scss */ "./src/util/scss.js");
/* harmony import */ var _export_open_export_dialog__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./export/open-export-dialog */ "./src/export/open-export-dialog.js");
...
/* harmony default export */ __webpack_exports__["default"] = (function (context) {
  Object(_export_open_export_dialog__WEBPACK_IMPORTED_MODULE_4__["default"])(context, {
    ...
    var stylesheet = '//export all text styles as mixins \n'; // stuff these in the stylesheet

    textStyles.forEach(function (textStyle) {
      stylesheet += "@mixin ".concat(textStyle.name, " {") + _util_scss__WEBPACK_IMPORTED_MODULE_3__["default"].createMixin(textStyle) + "}\n";
    });
    ...
    finalStylesList.forEach(function (textStyle) {
      stylesheet += _util_scss__WEBPACK_IMPORTED_MODULE_3__["default"].createMegaMixin(textStyle);
    });
    _util_ui__WEBPACK_IMPORTED_MODULE_0__["default"].createSavePanel('_supertype-mixins.scss', stylesheet);
  });
});
;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _list__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./list */ "./src/util/list.js");
/* harmony import */ var _number__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./number */ "./src/util/number.js");
/* harmony import */ var _string__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./string */ "./src/util/string.js");
...
var scss = {
  ...
  createMixin: function createMixin(textStyle) {
    ...
    function createCssProps(textStyle) {
      ...
      cssProps['text-transform'] = 'none'; // cssProps['margin-bottom'] = '$b';
      ...
      cssProps['font-size'] = _number__WEBPACK_IMPORTED_MODULE_1__["default"].parseFloatMaxDecimal(1 * textStyle.fontSize, 0) + opts.cssUnit;
    ...
    textStyle = createCssProps(textStyle); // then create styles

    textStyle = createStyleBlock(textStyle);
    return textStyle;
  },
  createMegaMixin: function createMegaMixin(textStyle) {
    // swap in the screen size as second to last name
    var i = textStyle.lastIndexOf('-');

    function insert(str, index, value) {
      return str.substr(0, index) + value + str.substr(index);
    }

    var phone = insert(textStyle, i, '-mobile');
    var tablet = insert(textStyle, i, '-tablet');
    var desktop = insert(textStyle, i, '-desktop');
    return "@mixin ".concat(textStyle, " {\n\n        @include media($tablet) { @include ").concat(tablet, " }\n\n        @include media($tablet--gt) { @include ").concat(desktop, " }\n\n        @include media($phone) { @include ").concat(phone, " }\n  \n        }\n");
  }
};
/* harmony default export */ __webpack_exports__["default"] = (scss);
...
//# sourceMappingURL=mixins-export.js.map